...
@Service
public class OfficerTaskPublishService implements AbstractUpdateService<Officer, Task> {
	...
	public void validate(final Request<Task> request, final Task entity, final Errors errors) {
		...
		if (!errors.hasErrors("start")) {
			...
			errors.state(request, entity.getStart().after(minimumDeadline), "start", "officer.task.form.error.too-close");
		}
	}
