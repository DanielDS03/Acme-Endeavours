...
<acme:form>
	...
	<acme:form-submit code="workplan.form.button.create" action="/officer/workplan/create"/>
  	<acme:form-return code="workplan.form.button.return"/>
  	<acme:form-submit code="workplan.form.button.delete" action="/officer/workplan/delete"/>
