...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.duty"
		...
		<acme:menu-option code="master.menu.administrator"
			...
			<acme:menu-suboption code="master.menu.administrator.spam"
				action="/administrator/spam/create" />
			<acme:menu-suboption
				code="master.menu.administrator.spam.list"
				action="/administrator/spam/list" />
			<acme:menu-suboption code="master.menu.administrator.threshold"
				action="/administrator/threshold/update" />
		</acme:menu-option>

		<acme:menu-option code="master.menu.authenticated"
			access="isAuthenticated()">
			<acme:menu-suboption code="master.menu.duty"
		...
		<acme:menu-option code="master.menu.officer" access="hasRole('Officer')">
			<acme:menu-suboption code="master.menu.officer.duty"
